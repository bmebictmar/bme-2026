...
::: {.callout-tip title="Usuários do Google Colab"}

Se você estiver usando o **Google Colab**, o arquivo `regressao_polinomial_exemplo.csv` precisa ser carregado manualmente antes de executar a célula abaixo. Siga as instruções em [Importando data frames a partir de arquivos CSV](https://fcopf.github.io/mead/content/manipulacao-dados-python/importa-dados-python.html){target="_blank"} para baixar o arquivo e adicioná-lo ao seu ambiente no Colab.
